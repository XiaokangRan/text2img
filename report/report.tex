...
disentangle rotations of the bird, the second dimension has learnt to disentangle
...
\caption{The generations of flowers for the text 'the large thin lower petals
    are lavender in color; the smaller upper white petals are more oval in
    shape, and the many thin stamens are long with small yellow anthers.' with
