...
\begin{figure}
    ...
    \caption{High-level architecture for Text to Image InfoGAN model. The grey convolution blocks follow the DCGAN architecture. Dashed arrows represent alternate flows.}
    \label{fig:arch}
\end{figure}
