...
Our final codebase can be found at \url{https://github.com/alemc2/text2img}. The \texttt{README.md} file in the code repository explains how to learn the model and generate images for queries. You can also choose to enable the argument \texttt{web} of \texttt{txt2img\_demo.lua} to get start a web server where you can submit a query, generate images and then adjust those images with sliders representing learnt latent codes.
...
A screenshot of this web interface we developed is shown in Figure \ref{fig:web}.
